...
public:
  ...
  uint16_t year() const { /*! return the current year */ return 2000 + yOff; }
  uint8_t month() const { /*! return the current month */ return m; }
  uint8_t day() const { /*! return the current day of the month */ return d; }
  uint8_t hour() const { /*! return the current hour */ return hh; }
  uint8_t minute() const { /*! return the current minute */ return mm; }
  uint8_t second() const { /*! return the current second */ return ss; }
  ...
  DateTime operator-(const TimeSpan& span); /*! Overloaded "+" operator to add two timespans */
  TimeSpan operator-(const DateTime& right); /*! Overloaded "-" operator subtract add two timespans */
protected:
...
public:
  ...
  *************************************************************************************************/
  template <typename T> uint8_t& readRAM(const uint8_t& addr, T& value) const {
    /*!
  ...
  template <typename T> bool writeRAM(const uint8_t& addr, const T& value) const {
    /*!
...
private:
  ...
  *************************************************************************************************/
  template <typename T> uint8_t I2C_read(const uint8_t address, T& value) const {
    /*!
  ...
  template <typename T> uint8_t I2C_write(const uint8_t address, const T& value) const {
    /*!
